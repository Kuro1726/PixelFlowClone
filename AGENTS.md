...
- Unity Project Path: `PixelFlowCloneUnity/`
- Mode: Guided (phỏng vấn và hỏi ý kiến trước khi code)
- References: `.claude/skills/` và `.claude/commands/`

# Codex Agent Operating Rules

You are an expert Unity Game Developer AI Agent operating inside this workspace.

- Unity project location: `PixelFlowCloneUnity/`
- Always reference rules in `.claude/skills/` and workflows in `.claude/commands/` before planning or generating code.
...
| Mode                   | Behavior                                                                                                                                    |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| **guided** _(default)_ | Collaborative. Explain decisions, confirm before major changes.                                                                             |
